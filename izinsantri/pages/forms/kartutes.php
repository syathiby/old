...
<head>
    ...
    <title>Hasil Seleksi Berkas - PSB Online | Ma'had Al Imam Asy Syathiby</title>
    <!-- Favicon-->
                        ...
                        <div class="header">
                            ...
                            if($hasil_berkas == "Diproses"){
                                ...
                                <p>
                                    ...
                                    2x24 jam.<br>
                                    Bagi anda yang dinyatakan <b>LULUS</b> anda bisa langsung <b>Cetak Kartu Tes</b> dan bisa mengikuti tes masuk. Namun, jika anda 
                            ...
                            ?>
                               <p>    
                                ...
                                <br>
                                <br>
                                Selanjutnya silahkan untuk mencetak (print) <b>Kartu Tes.</b> Calon Santri <b>WAJIB</b> membawa Kartu Tes saat hadir untuk <b>Pelaksanaan Tes Masuk</b>.
                                <br>
                            </p> 
                            <?php
                            }
                            ...
                            <div class="body">
                                ...
                                <strong>PERHATIAN!</strong> Calon santri <strong>WAJIB Mencetak/Print Kartu Tes Dengan Ukuran Kertas A5 (Setengah A4)</strong> dan Membawanya Saat Pelaksanaan Tes Masuk.
                                </div>
                                <?php 
                                ...
                                if($bukti == ""){
                                 ...
                                 <!--Tombol Update-->
                                    ...
                                    <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4 form-control-label">
                                        <label for="username">Total Hafalan</label>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="hafalan" class="form-control" 
                                                value="<?php echo $data_ubah['hafalan'] ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <a href="../../img/<?php echo $folder;?>/<?php echo $data_ubah['transfer']; ?>" data-sub-html="Bukti Transfer">
                                            <img class="img-responsive thumbnail" src="../../img/<?php echo $folder;?>/<?php echo $data_ubah['transfer']; ?>" width="150px">
                                        </a>
                                    </div>
                                    </div>
                                    ...
                                    <?php
                                         if(isset($_POST['update'])){
                                            ...
                                            $nama_transfer = $_FILES['transfer']['name'];
                                              ...
                                              $simpantransfer = "../../img/$folder/".$time."-".$acak."-".$nama_transfer;
                                              $transferbaru = $time."-".$acak."-".$nama_transfer;
                                              
                                            $upphoto = move_uploaded_file($transfer, $simpantransfer);
                                            
                                            if($upphoto == true){
                                             $isidata = mysqli_query($koneksi, "UPDATE identitas SET transfer='$transferbaru' 
                                             WHERE id='$kode'"); 
                                            }
                                         ...
                                         ?>
                                          <script type="text/javascript">
                                          alert("Upload GAGAL, Periksa Koneksi Internet Anda dan Ukuran File!");
                                          </script>
                                         <?php 
                                         }
                                      }
