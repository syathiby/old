            ...
            if(($ukuranphoto < 1044070) and ($ukurantranskrip < 1044070) and ($ukurankartu_kel < 1044070) and ($ukuranktp_ortu < 1044070) 
                ...
                if(($upphoto == true) and ($uptranskrip == true) and ($upkk == true) and ($upktp == true) and ($upsurat == true)){
                    ...
                    <?php
                        ...
                        '$tempat_lahir','$tgl_lahir','$alamat_santri','$jk','$asal_sekolah','$program_pilihan','$nama_ayah',
                        ...
                        '$ktp_ortubaru','$surat_sehatbaru','','Santri','$bulan_daftar')");
                    }
                    if($tulisdata == true){
                        ?>
                        <script type="text/javascript">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <form id="sign_in" action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <?php
                                $carikode = mysqli_query("SELECT max(noreg) from identitas") or die (mysql1_error());
                                    $datakode = mysqli_fetch_array($carikode);
                                        if ($datakode){
                                        $nilaikode = substr($datakode[0], 1);
                                        $kode = (int) $nilaikode;
                                        $kode = $kode + 1;
                                        $hasilkode = "PSB200701".str_pad($kode,3,"0,STR_PAD_LEFT");
                                        }
                                        else {
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" name="noreg" class="form-control" value="<?php echo $hasilkode; ?>" />
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <select name="bulan_daftar" class="form-control">
                                                <option value="----">----</option>
                                                <option value="Pekan 5">27 OKT-02 NOV 2019</option>
                                                <option value="Pekan 1">03-09 NOV 2019</option>
                                                <option value="Pekan 2">10-16 NOV 2019</option>
                                                <option value="Pekan 3">17-23 NOV 2019</option>
                                                <option value="Pekan 4">24-30 NOV 2019</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10 col-md-8 col-sm-8 col-xs-8 mt-15">
                                        ...
                                        <div class="demo-checkbox">
                                        	<div class="form-line">
                                				...
                                				<input name="program_pilihan" value="SMA Diniyyah Putra" type="radio" id="radio_3" class="radio-col-red"/>
                                				<label for="radio_5">SMA Diniyyah Putra</label>
                                				<input name="program_pilihan" value="SMA Diniyyah Putri" type="radio" id="radio_4" class="radio-col-blue" />
                                				<label for="radio_6">SMA Diniyyah Putri</label>
                                			</div>
                                    	</div>
                                    	</div>
                                    </div>
