    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">Selamat Datang di Portal Academy</div>
        ...
        <aside id="rightsidebar" class="right-sidebar">
            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                <li role="presentation" class="active"><a href="#skins" data-toggle="tab">UBAH WARNA WEB</a></li>
            </ul>
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if($_SESSION['username']){
                                ...
                                $sql_ubah=mysqli_query($koneksi, "SELECT * FROM tb_tes WHERE username='$usern'");
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 form-control-label">
                                        <label for="tempat_lahir">Photo 3x4</label>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="form-group">
                                            <div>
                                                <img src="../../img/<?php echo $data_ubah['photodiri']; ?>" width="150px" />
                                            </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <button type="submit" name="edit" class="btn btn-primary m-t-15 waves-effect">Simpan</button>
                                    </div>
                                </div>
                                <?php 
                                if(isset($_POST['edit'])){
                                    ...
                                    mysqli_query($koneksi, "UPDATE akun set namadepan='$namadepan', tempat_lahir='$tempat_lahir' WHERE 
                                        username='$usern'");
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = mysqli_query ($koneksi, "SELECT * FROM akun WHERE jk='laki-laki' ORDER BY id DESC") or die (mysqli_error());
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <?php 
                                            $sql = mysqli_query ($koneksi, "SELECT * FROM akun WHERE jk='perempuan' ORDER BY id DESC") or die (mysqli_error());
                                            while ($data = mysqli_fetch_array ($sql)) {
