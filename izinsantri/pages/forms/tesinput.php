            ...
            if($ukuranphoto < 1044070){
                ...
                if(($upphoto == true) and ($uptranskrip == true) and ($upkk == true) and ($upktp == true) and ($upsurat == true)){
                    ...
                    <?php
                        ...
                        'Menunggu','Diproses','Diproses','$photobaru','$transkripbaru','$kartu_kelbaru','$ktp_ortubaru','$surat_sehatbaru','')");
                    }
                    if($tulisdata == true){
                        ?>
                        <script type="text/javascript">
                        ...
                        <div class="body">
                            <div class="row-clearfix">
                             ...
                             <?php 
                                ...
                                $hitung1 = mysqli_num_rows($sql_cek);
                                ?>
                             ...
                             <?php 
                                ...
                                $hitung2 = mysqli_num_rows($sql_cek);
                                ?>
                             ...
                             <?php 
                                ...
                                <br>
                                2. Isi formulir di bawah ini dengan <b>lengkap dan benar</b>
                                <br>
                                <br>
                                3. Setelah dinyatakan <b>Berhasil Daftar,</b> silahkan <b>Login</b> menggunakan <b>Username dan Password</b> yang digunakan untuk mendaftar
                                <br>
                                <br>
                                4. Jika anda merasa kesulitan, silahkan lihat <b>Video Panduan Penggunaan Aplikasi</b> <a href="../ui/video-panduan.php">Disini!</a>
                                </p>
                            </div>
                            ...
                            <form id="sign_in" action="" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tempat_lahir" class="form-control" placeholder="Tempat/Kota Kelahiran"/>
                                            </div>
                                ...
                                <div class="row clearfix">
                                 ...
                                 <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <textarea rows="4" name="alamat_santri" class="form-control no-resize" placeholder="Tulis alamat lengkap beserta Desa/Kelurahan, Kecamatan, Kab/Kota dan Provinsi"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="asal_sekolah" class="form-control" placeholder="Tulis Nama Sekolah Sebelumnya" />
                                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tmp_ayah" class="form-control" placeholder="Tempat/Kota Kelahiran"/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <textarea rows="4" name="alamat_ayah" class="form-control no-resize" placeholder="Tulis alamat lengkap beserta Desa/Kelurahan, Kecamatan, Kab/Kota dan Provinsi"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tmp_ibu" class="form-control" placeholder="Tempat/Kota Kelahiran"/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <textarea rows="4" name="alamat_ibu" class="form-control no-resize" placeholder="Tulis alamat lengkap beserta Desa/Kelurahan, Kecamatan, Kab/Kota dan Provinsi"></textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="tmp_wali" class="form-control" placeholder="Tempat/Kota Kelahiran"/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                            <textarea rows="4" name="alamat_wali" class="form-control no-resize" placeholder="Tulis alamat lengkap beserta Desa/Kelurahan, Kecamatan, Kab/Kota dan Provinsi"></textarea>
                                            </div>
                                        </div>
