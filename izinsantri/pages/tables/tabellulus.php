                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div>
                                <input type="hidden" name="id" class="form-control" value="<?php echo $data_baru['id'] ?>" />
                            </div>
                            
                            <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 form-control-label">
                                        <label for="tempat_lahir">Status Publikasi</label>
                                    </div>
                                    <div class="col-lg-2 col-md-2">
                                        <div class="form-group">
                                            <select name="publikasi" class="form-control">
                                                <option><?php echo $data_baru['publikasi']?></option>
                            ...
                            <?php
                             if(isset($_POST['simpan'])){
                                ...
                                $update = mysqli_query($koneksi, "UPDATE identitas SET publikasi = '$publikasi' WHERE id='$id'");
                                
                                if($update == true) {
                                    ?>
                                    <script type="text/javascript">
                                        alert("Oke! Sudah Disimpan");
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                            <th>Rank</th>
                                            <th>Nama Lengkap</th>
                                            <th>Tes Tahfizh (60)</th>
                                            <th>Tes Psikologi (20)</th>
                                            <th>Tes Kesehatan (20)</th>
                                            <th>Wawancara Anak</th>
                                    ...
                                    <tbody>
                                       <?php 
                                            ...
                                            WHERE identitas.level='Santri' AND identitas.jk='Laki-laki' ORDER BY hasil.nilai_akhir DESC") or die (mysqli_error());
                                            $no=1;
                                            while ($data = mysqli_fetch_array ($sql)) {
                                            $status1 = $data['publikasi'];
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $data['tes_tahfizh'];?></td>
                                            <td><?php echo $data['tes_psikologi']; ?></td>
                                            <td><?php echo $data['tes_kesehatan']; ?></td>
                                            <td><?php echo $data['tes_wawancara']; ?></td>
                                            <td><?php echo $data['ortu_wawancara']; ?></td>
                                            <td><?php echo $data['nilai_akhir']; ?></td>
                                            <td><?php echo $data['hasil_akhir']; ?></td>
                                            <td>
                                                <?php
                                                if($data['daftar_ulang'] == "Tentukan") { ?>
                                                Belum Konfirmasi
                                                <?php
                                                }
                                                else {
                                                    ?>
                                                    <?php echo $data['daftar_ulang']; ?>
                                                <?php }
                                                ?>
                                            </td>
                                            <td>
                                            <a href="../forms/hasilakhir.php?id=<?php echo $data['id']; ?>"><button class="btn bg-blue btn-block btn-xs waves-effect">Detail</button></a></td>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                       <?php 
                                            $sql = mysqli_query ($koneksi, "SELECT * FROM identitas INNER JOIN hasil ON identitas.username = hasil.username 
                                            WHERE identitas.level='Santri' AND identitas.jk='Perempuan' ORDER BY hasil.nilai_akhir DESC") or die (mysqli_error());
                                            $no=1;
                                            while ($data = mysqli_fetch_array ($sql)) {
